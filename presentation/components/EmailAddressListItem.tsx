...
export default class EmailAddressListItem extends React.Component<
  EmailAddressListItemProps,
  EmailAddressListItemState
> {
  constructor(props) {
    super(props)
  ...
  public render() {
    ...
    return (
      <li className="list-group-item w-100 d-flex align-items-center">
        {e.verified ? (
          <i className="text-primary fa fa-fw fa-check-circle mr-2" />
        ) : (
          <i className="text-muted fa fa-fw fa-question-circle mr-2" />
        )}
        {e.emailAddress}
