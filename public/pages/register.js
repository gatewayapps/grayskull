              ...
              <div className="card">
                ...
                {props.error && <div className="alert alert-danger">{props.error.message}</div>}
                    <div className="form-group row">
                      <label className='col-sm-12 col-md-3 col-form-label' htmlFor="emailAddress">E-mail Address: </label>
                      <div className='col-sm-12 col-md-9'>
                        <input type="text" readOnly className="form-control-plaintext" name="emailAddress" value={props.emailAddress} />
                      </div>
                    </div>
                    <div className='form-group row mt-5'>
                    <label className='col-sm-12 col-md-3 col-form-label' htmlFor="firstName">First Name: </label>
                      <div className='col-sm-12 col-md-9'>
                        <input type="text" className="form-control" name="firstName" defaultValue={props.data.firstName} />
                      </div>
                    </div>
                    <div className='form-group row'>
                    <label className='col-sm-12 col-md-3 col-form-label' htmlFor="lastName">Last Name: </label>
                      <div className='col-sm-12 col-md-9'>
                        <input type="text" className="form-control" name="lastName" defaultValue={props.data.lastName} />
                      </div>
                    </div>
                    <div className="form-group row mt-5">
                      <label className='col-sm-12 col-md-3 col-form-label' htmlFor="password">Password: </label>
                      <div className='col-sm-12 col-md-9'>
                        <input type="password" className="form-control" name="password" />
                      </div>
                    </div>
                    <div className="form-group row">
                      <label className='col-sm-12 col-md-3 col-form-label' htmlFor="confirm">Confirm: </label>
                      <div className='col-sm-12 col-md-9'>
