                  ...
                  <div className='card-body'>
                    ...
                    {this.state.result && (
                      <div className='alert alert-success'>
                        <p>
                          Success! Your client_id and client_secret that your application will use to authenticate users are listed below.
                          Please note these values down as this is the only time the client_secret will be visible.
                        </p>
                        <div><strong>Client Id:</strong> {this.state.result.client_id}</div>
                        <div><strong>Secret:</strong> {this.state.result.secret}</div>
                      </div>
                    )}
                  </div>
                  {!this.state.result && (
